$(document).ready(function() {
    ...
    /**
     *
     * show more form popup
     *
     */

    $.martanianShowMorePopup = function() {

        var mode = windowWidth > 932 && windowHeight > 670 ? 'fixed' : 'absolute';

        $('#more-popup #more-popup-background').fadeIn(300);
        if (mode == 'absolute') $('html, body').animate({
            'scrollTop': '0'
        }, 300);

        setTimeout(function() {

            if (mode == 'fixed') $('#more-popup #more-popup-content').addClass('bounceInDown').css({
                'top': '50%',
                'position': 'fixed'
            });
            else $('#more-popup #more-popup-content').addClass('bounceInDown').css({
                'top': '50px',
                'marginTop': '0px',
                'position': 'absolute'
            });
    ...
    /**
     *
     * hide more form popup
     * 
     */

    $.martanianHideMorePopup = function() {

        $('#more-popup #more-popup-content').removeClass('bounceInDown').addClass('bounceOutUp');
        setTimeout(function() {

            $('#more-popup #more-popup-background').fadeOut(300);
            $('#more-popup #more-popup-content').css({
                'top': '-10000px'
    ...
    /**
     *
     * hooks to show more form popup
     *
     */

    $('*[data-action="show-more-popup"]').click(function() {

        $.martanianShowMorePopup();

    });

    /**
     *
     * hooks to hide more form popup
     *
     */

    $('#more-popup-close').click(function() {

        $.martanianHideMorePopup();
